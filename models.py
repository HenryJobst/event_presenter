...
#
# Generated Fri Jun 23 20:25:59 2023 by generateDS.py version 2.41.5.
# Python 3.11.0b5 (v3.11.0b5:0771d71eea, Jul 25 2022, 22:31:48) [Clang 13.0.0 (clang-1300.0.29.30)]
#
...
#   /Users/henryprivat/Downloads/IOF.xsd
#
# Command line:
#   /Users/henryprivat/Library/Caches/pypoetry/virtualenvs/event-presenter-3zAHc4WX-py3.11/bin/generateDS -a "xsd:" -o "models.py" /Users/henryprivat/Downloads/IOF.xsd
#
...
class BaseMessageElement(GeneratedsSuper):
    ...
    * creator --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BaseMessageElement', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BaseMessageElement')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='BaseMessageElement', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='BaseMessageElement'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BaseMessageElement', fromsubclass_=False, pretty_print=True):
        pass
...
class CompetitorList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Competitor=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("CompetitorList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            super(CompetitorList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='CompetitorList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CompetitorList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CompetitorList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CompetitorList'):
        super(CompetitorList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CompetitorList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='CompetitorList', fromsubclass_=False, pretty_print=True):
        super(CompetitorList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(CompetitorList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        super(CompetitorList, self)._buildChildren(child_, node, nodeName_, True)
...
class OrganisationList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Organisation=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("OrganisationList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            self.Extensions is not None or
            super(OrganisationList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='OrganisationList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='OrganisationList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='OrganisationList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='OrganisationList'):
        super(OrganisationList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='OrganisationList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='OrganisationList', fromsubclass_=False, pretty_print=True):
        super(OrganisationList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(OrganisationList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Organisation':
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(OrganisationList, self)._buildChildren(child_, node, nodeName_, True)
...
class EventList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Event=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("EventList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
        if Event is None:
            self.Event = []
        else:
            self.Event = Event
    ...
    def has__content(self):
        if (
            self.Event or
            self.Extensions is not None or
            super(EventList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='EventList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EventList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='EventList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='EventList'):
        super(EventList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EventList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='EventList', fromsubclass_=False, pretty_print=True):
        super(EventList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(EventList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Event':
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(EventList, self)._buildChildren(child_, node, nodeName_, True)
# end class EventList
...
class ClassList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Class=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("ClassList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
        if Class is None:
            self.Class = []
        else:
            self.Class = Class
    ...
    def has__content(self):
        if (
            self.Class or
            self.Extensions is not None or
            super(ClassList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ClassList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ClassList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClassList'):
        super(ClassList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ClassList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassList', fromsubclass_=False, pretty_print=True):
        super(ClassList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(ClassList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Class':
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(ClassList, self)._buildChildren(child_, node, nodeName_, True)
# end class ClassList
...
class EntryList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Event=None, TeamEntry=None, PersonEntry=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("EntryList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
        self.Event = Event
        self.Event_nsprefix_ = None
    ...
    def has__content(self):
        if (
            ...
            self.PersonEntry or
            self.Extensions is not None or
            super(EntryList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='EntryList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EntryList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='EntryList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='EntryList'):
        super(EntryList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EntryList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='EntryList', fromsubclass_=False, pretty_print=True):
        super(EntryList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(EntryList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Event':
            obj_ = Event.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(EntryList, self)._buildChildren(child_, node, nodeName_, True)
# end class EntryList
...
class CourseData(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Event=None, RaceCourseData=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("CourseData"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
        self.Event = Event
        self.Event_nsprefix_ = None
    ...
    def has__content(self):
        if (
            ...
            self.Extensions is not None or
            super(CourseData, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='CourseData', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CourseData')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CourseData', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CourseData'):
        super(CourseData, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CourseData')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='CourseData', fromsubclass_=False, pretty_print=True):
        super(CourseData, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(CourseData, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Event':
            obj_ = Event.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(CourseData, self)._buildChildren(child_, node, nodeName_, True)
...
class StartList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Event=None, ClassStart=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("StartList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
        self.Event = Event
        self.Event_nsprefix_ = None
    ...
    def has__content(self):
        if (
            ...
            self.ClassStart or
            self.Extensions is not None or
            super(StartList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='StartList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='StartList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='StartList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StartList'):
        super(StartList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='StartList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='StartList', fromsubclass_=False, pretty_print=True):
        super(StartList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(StartList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Event':
            obj_ = Event.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(StartList, self)._buildChildren(child_, node, nodeName_, True)
# end class StartList
...
class ResultList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, status='Complete', Event=None, ClassResult=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("ResultList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            self.ClassResult or
            self.Extensions is not None or
            super(ResultList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ResultList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ResultList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ResultList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ResultList'):
        super(ResultList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ResultList')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ResultList', fromsubclass_=False, pretty_print=True):
        super(ResultList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(ResultList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Event':
            obj_ = Event.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(ResultList, self)._buildChildren(child_, node, nodeName_, True)
...
class ServiceRequestList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Event=None, OrganisationServiceRequest=None, PersonServiceRequest=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("ServiceRequestList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
        self.Event = Event
        self.Event_nsprefix_ = None
    ...
    def has__content(self):
        if (
            ...
            self.Extensions is not None or
            super(ServiceRequestList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ServiceRequestList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ServiceRequestList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ServiceRequestList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ServiceRequestList'):
        super(ServiceRequestList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ServiceRequestList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ServiceRequestList', fromsubclass_=False, pretty_print=True):
        super(ServiceRequestList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(ServiceRequestList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Event':
            obj_ = Event.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(ServiceRequestList, self)._buildChildren(child_, node, nodeName_, True)
...
class ControlCardList(BaseMessageElement):
    ...
    * Extensions --
    ...
    def __init__(self, iofVersion='3.0', createTime=None, creator=None, Owner=None, ControlCard=None, Extensions=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("ControlCardList"), self).__init__(iofVersion, createTime, creator,  **kwargs_)
        self.Owner = Owner
    ...
    def has__content(self):
        if (
            ...
            self.ControlCard or
            self.Extensions is not None or
            super(ControlCardList, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ControlCardList', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ControlCardList')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ControlCardList', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ControlCardList'):
        super(ControlCardList, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ControlCardList')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ControlCardList', fromsubclass_=False, pretty_print=True):
        super(ControlCardList, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(ControlCardList, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Owner':
            value_ = child_.text
            ...
            self.Extensions = obj_
            obj_.original_tagname_ = 'Extensions'
        super(ControlCardList, self)._buildChildren(child_, node, nodeName_, True)
...
class Person(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Person', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonName(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonName', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonName')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonName', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonName'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonName', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Competitor(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Competitor', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Competitor')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Competitor', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Competitor'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Competitor', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ControlCard(GeneratedsSuper):
    ...
    * punchingSystem --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ControlCard', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ControlCard')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ControlCard'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ControlCard', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Score(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Score', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Score')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Score'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Score', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Organisation(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Organisation', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Organisation')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Organisation', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Organisation'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Organisation', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Role(GeneratedsSuper):
    ...
    * type --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Role', pretty_print=True):
        ...
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Role', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Role'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Role', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    * Extensions --
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Event'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Event', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class EntryReceiver(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='EntryReceiver', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EntryReceiver')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='EntryReceiver', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='EntryReceiver'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='EntryReceiver', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Race(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Race', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Race')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Race', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Race'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Race', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class EventURL(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EventURL', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EventURL')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='EventURL'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EventURL', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    * Details --
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Schedule'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Schedule', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class InformationItem(GeneratedsSuper):
    ...
    * Content --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='InformationItem', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='InformationItem')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='InformationItem', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='InformationItem'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='InformationItem', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    * Extensions --
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Class'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Class', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ClassType(GeneratedsSuper):
    ...
    * Name --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ClassType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ClassType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClassType'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RaceClass(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='RaceClass', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RaceClass')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RaceClass', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RaceClass'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='RaceClass', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Fee(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Fee', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Fee')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Fee', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Fee'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Fee', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class AssignedFee(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='AssignedFee', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='AssignedFee')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='AssignedFee', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='AssignedFee'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='AssignedFee', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonEntry(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonEntry', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonEntry')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonEntry', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonEntry'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonEntry', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamEntry(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamEntry', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamEntry')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamEntry', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamEntry'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamEntry', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamEntryPerson(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamEntryPerson', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamEntryPerson')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamEntryPerson', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamEntryPerson'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamEntryPerson', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class StartTimeAllocationRequest(GeneratedsSuper):
    ...
    * Person --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='StartTimeAllocationRequest', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='StartTimeAllocationRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='StartTimeAllocationRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StartTimeAllocationRequest'):
        if self.type_ != "Normal" and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='StartTimeAllocationRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ClassStart(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassStart', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ClassStart')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ClassStart', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClassStart'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassStart', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class StartName(GeneratedsSuper):
    ...
    * raceNumber --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='StartName', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='StartName')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StartName'):
        if self.raceNumber is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            outfile.write(' raceNumber="%s"' % self.gds_format_integer(self.raceNumber, input_name='raceNumber'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='StartName', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class PersonStart(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonStart', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonStart')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonStart', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonStart'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonStart', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonRaceStart(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonRaceStart', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonRaceStart')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonRaceStart', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonRaceStart'):
        if self.raceNumber is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            outfile.write(' raceNumber="%s"' % self.gds_format_integer(self.raceNumber, input_name='raceNumber'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonRaceStart', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamStart(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamStart', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamStart')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamStart', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamStart'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamStart', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamMemberStart(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberStart', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamMemberStart')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamMemberStart', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamMemberStart'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberStart', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamMemberRaceStart(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberRaceStart', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamMemberRaceStart')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamMemberRaceStart', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamMemberRaceStart'):
        if self.raceNumber is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            outfile.write(' raceNumber="%s"' % self.gds_format_integer(self.raceNumber, input_name='raceNumber'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberRaceStart', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ClassResult(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassResult', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ClassResult')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ClassResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClassResult'):
        if self.timeResolution != 1 and 'timeResolution' not in already_processed:
            already_processed.add('timeResolution')
            outfile.write(' timeResolution="%s"' % self.gds_format_double(self.timeResolution, input_name='timeResolution'))
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonResult(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonResult', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonResult')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonResult'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonRaceResult(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonRaceResult', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonRaceResult')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonRaceResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonRaceResult'):
        if self.raceNumber is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            outfile.write(' raceNumber="%s"' % self.gds_format_integer(self.raceNumber, input_name='raceNumber'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonRaceResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamResult(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamResult', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamResult')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamResult'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamMemberResult(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberResult', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamMemberResult')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamMemberResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamMemberResult'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamMemberRaceResult(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberRaceResult', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamMemberRaceResult')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamMemberRaceResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamMemberRaceResult'):
        if self.raceNumber is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            outfile.write(' raceNumber="%s"' % self.gds_format_integer(self.raceNumber, input_name='raceNumber'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberRaceResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class OverallResult(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='OverallResult', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='OverallResult')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='OverallResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='OverallResult'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='OverallResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ControlAnswer(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ControlAnswer', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ControlAnswer')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ControlAnswer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ControlAnswer'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ControlAnswer', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SplitTime(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='SplitTime', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SplitTime')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SplitTime', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SplitTime'):
        if self.status != "OK" and 'status' not in already_processed:
            already_processed.add('status')
            outfile.write(' status=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.status), input_name='status')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='SplitTime', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Route(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Route', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Route')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Route'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Route', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Leg(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Leg', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Leg')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Leg', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Leg'):
        ...
        if self.maxNumberOfCompetitors != 1 and 'maxNumberOfCompetitors' not in already_processed:
            already_processed.add('maxNumberOfCompetitors')
            outfile.write(' maxNumberOfCompetitors="%s"' % self.gds_format_integer(self.maxNumberOfCompetitors, input_name='maxNumberOfCompetitors'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Leg', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Control(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Control', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Control')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Control', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Control'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Control', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GeoPosition(GeneratedsSuper):
    ...
    * alt --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GeoPosition', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='GeoPosition')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='GeoPosition', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GeoPosition'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GeoPosition', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Map(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Map'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Map', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class MapPosition(GeneratedsSuper):
    ...
    * unit --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='MapPosition', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='MapPosition')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='MapPosition', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='MapPosition'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='MapPosition', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class RaceCourseData(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='RaceCourseData', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RaceCourseData')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RaceCourseData', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RaceCourseData'):
        if self.raceNumber is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            outfile.write(' raceNumber="%s"' % self.gds_format_integer(self.raceNumber, input_name='raceNumber'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='RaceCourseData', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ClassCourseAssignment(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassCourseAssignment', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ClassCourseAssignment')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ClassCourseAssignment', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClassCourseAssignment'):
        if self.numberOfCompetitors is not None and 'numberOfCompetitors' not in already_processed:
            already_processed.add('numberOfCompetitors')
            outfile.write(' numberOfCompetitors="%s"' % self.gds_format_integer(self.numberOfCompetitors, input_name='numberOfCompetitors'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ClassCourseAssignment', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonCourseAssignment(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonCourseAssignment', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonCourseAssignment')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonCourseAssignment', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonCourseAssignment'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonCourseAssignment', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamCourseAssignment(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamCourseAssignment', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamCourseAssignment')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamCourseAssignment', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamCourseAssignment'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamCourseAssignment', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TeamMemberCourseAssignment(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberCourseAssignment', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TeamMemberCourseAssignment')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TeamMemberCourseAssignment', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TeamMemberCourseAssignment'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='TeamMemberCourseAssignment', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Course(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Course', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Course')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Course', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Course'):
        if self.numberOfCompetitors is not None and 'numberOfCompetitors' not in already_processed:
            already_processed.add('numberOfCompetitors')
            outfile.write(' numberOfCompetitors="%s"' % self.gds_format_integer(self.numberOfCompetitors, input_name='numberOfCompetitors'))
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Course', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SimpleCourse(GeneratedsSuper):
    ...
    * NumberOfControls --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='SimpleCourse', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SimpleCourse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SimpleCourse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SimpleCourse'):
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            already_processed.add('xsi:type')
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            if ":" not in self.extensiontype_:
                ...
                outfile.write(' xsi:type="%s"' % self.extensiontype_)
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='SimpleCourse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SimpleRaceCourse(SimpleCourse):
    ...
    * raceNumber --
    ...
    def __init__(self, Id=None, Name=None, CourseFamily=None, Length=None, Climb=None, NumberOfControls=None, raceNumber=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("SimpleRaceCourse"), self).__init__(Id, Name, CourseFamily, Length, Climb, NumberOfControls,  **kwargs_)
        self.raceNumber = _cast(int, raceNumber)
        self.raceNumber_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
    ...
    def has__content(self):
        if (
            super(SimpleRaceCourse, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SimpleRaceCourse', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SimpleRaceCourse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SimpleRaceCourse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SimpleRaceCourse'):
        super(SimpleRaceCourse, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SimpleRaceCourse')
        if self.raceNumber is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            outfile.write(' raceNumber="%s"' % self.gds_format_integer(self.raceNumber, input_name='raceNumber'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SimpleRaceCourse', fromsubclass_=False, pretty_print=True):
        super(SimpleRaceCourse, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'raceNumber' not in already_processed:
            already_processed.add('raceNumber')
            self.raceNumber = self.gds_parse_integer(value, node, 'raceNumber')
        super(SimpleRaceCourse, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(SimpleRaceCourse, self)._buildChildren(child_, node, nodeName_, True)
        pass
...
class CourseControl(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='CourseControl', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CourseControl')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CourseControl', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CourseControl'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='CourseControl', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    * Extensions --
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Service'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Service', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class OrganisationServiceRequest(GeneratedsSuper):
    ...
    * PersonServiceRequest --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='OrganisationServiceRequest', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='OrganisationServiceRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='OrganisationServiceRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='OrganisationServiceRequest'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='OrganisationServiceRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonServiceRequest(GeneratedsSuper):
    ...
    * ServiceRequest --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonServiceRequest', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonServiceRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonServiceRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonServiceRequest'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='PersonServiceRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ServiceRequest(GeneratedsSuper):
    ...
    * Extensions --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ServiceRequest', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ServiceRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ServiceRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ServiceRequest'):
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='ServiceRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    * type --
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Address'):
        ...
        if self.modifyTime is not None and 'modifyTime' not in already_processed:
            already_processed.add('modifyTime')
            outfile.write(' modifyTime="%s"' % self.gds_format_datetime(self.modifyTime, input_name='modifyTime'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Address', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Country(GeneratedsSuper):
    ...
    * code --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Country', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Country')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Country'):
        if self.code is not None and 'code' not in already_processed:
            already_processed.add('code')
            outfile.write(' code=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.code), input_name='code')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Country', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class DateAndOptionalTime(GeneratedsSuper):
    ...
    * Time --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='DateAndOptionalTime', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DateAndOptionalTime')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DateAndOptionalTime', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DateAndOptionalTime'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='DateAndOptionalTime', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class LanguageString(GeneratedsSuper):
    ...
    * language --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='LanguageString', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='LanguageString')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='LanguageString'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='LanguageString', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Extensions(GeneratedsSuper):
    ...
    *  --
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Extensions', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Extensions')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Extensions', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Extensions'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.orienteering.org/datastandard/3.0" ', name_='Extensions', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TimeBehindType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TimeBehindType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TimeBehindType')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TimeBehindType'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TimeBehindType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
NamespaceToDefMappings_ = {'http://www.orienteering.org/datastandard/3.0': [('EventForm',
                                                   '../../../Downloads/IOF.xsd',
                                                   'ST'),
                                                  ('EventStatus',
                                                   '../../../Downloads/IOF.xsd',
